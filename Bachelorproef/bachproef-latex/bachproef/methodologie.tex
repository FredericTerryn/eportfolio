...
Dit is, binnen de applicatie, de \textunderscore{eerste filter}. De input is een lijst met foto's.
Elke foto die door cognitive services wordt toegewezen aan een \textunderscore{categorie} van de eerste groep (categorie met mogelijk PII), wordt uit die lijst verwijderd. Hiermee zouden al alle foto's met mensen op moeten verwijderd zijn. Dit is echter niet sluitend, dus is het aan te raden een \textunderscore{tweede filter} in te stellen als controle, op basis van \textunderscore{tags}. 
